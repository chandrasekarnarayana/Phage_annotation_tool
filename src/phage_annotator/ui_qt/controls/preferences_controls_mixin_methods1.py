"""Method group 1 split from preferences_controls_mixin.py."""
...
class _PreferencesControlsMixinMethods1:
    """Methods split from PreferencesControlsMixin."""

    def _show_preferences_dialog(self) -> None:
        """Show preferences dialog for the current workflow."""
