...
class ExtrasCommandPaletteMixin:
    """Method group 3 extracted from ThresholdControlsMixin."""

    def _run_analyze_particles(self) -> None:
        """Run analyze particles for the current workflow."""
    ...
    def _populate_particles_table(self) -> None:
        """Handle the populate particles table helper flow."""
        if self.particles_panel is None:
            return
    ...
    def _particles_selection_changed(self) -> None:
        """Handle the particles selection changed helper flow."""
        if self.particles_panel is None:
            return
    ...
    def _particles_refresh_overlay(self) -> None:
        """Handle the particles refresh overlay helper flow."""
