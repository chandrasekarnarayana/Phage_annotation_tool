...
from phage_annotator.ui_qt.utils.dock_roi_widgets import make_roi_manager_widget, make_results_widget, make_recorder_widget, make_hist_widget, make_profile_widget, make_orthoview_widget, make_smlm_widget, make_threshold_widget, make_particles_widget, make_channel_controls_widget, make_deepstorm_widget, make_onnx_density_widget
