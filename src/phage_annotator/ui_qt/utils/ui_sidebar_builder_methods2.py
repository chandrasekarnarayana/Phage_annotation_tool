"""Method group 2 split from ui_sidebar_builder.py."""
...
class _UiSidebarBuilderMixinMethods2:
    ...
    def _build_sidebar_pages(
        ...
        """Document the build_sidebar_pages flow."""
        ...
        def _stack_sections(*sections: QtWidgets.QWidget) -> QtWidgets.QWidget:
            """Document the stack_sections flow."""
        ...
        def _build_lazy_loading_section() -> QtWidgets.QWidget:
            """Document the build_lazy_loading_section flow."""
        ...
        def _build_roi_page_section() -> QtWidgets.QWidget:
            """Document the build_roi_page_section flow."""
            section = QtWidgets.QWidget()
            layout = QtWidgets.QVBoxLayout(section)
            layout.setContentsMargins(0, 0, 0, 0)
            layout.setSpacing(10)
        ...
        def _trigger_action(action_name: str) -> None:
            """Document the trigger_action flow."""
