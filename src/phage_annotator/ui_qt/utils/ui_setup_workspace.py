...
def build_modality_loader_section(owner, explore_layout: QtWidgets.QVBoxLayout) -> None:
    ...
    modality_layout.addWidget(owner.lazy_loader_tree)
    ...
    owner.lazy_remove_btn = QtWidgets.QPushButton("Clear")
    owner.lazy_remove_btn.setToolTip("Clear previous loaded sources and reset to the current image.")
    ...
    controls_row.addWidget(owner.lazy_open_btn)
