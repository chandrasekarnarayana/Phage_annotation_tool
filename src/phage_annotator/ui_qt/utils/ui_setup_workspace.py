...
def build_modality_loader_section(owner, explore_layout: QtWidgets.QVBoxLayout) -> None:
    ...
    owner.lazy_modality_table.horizontalHeader().setStretchLastSection(True)
    ...
    owner.lazy_add_raw_btn = QtWidgets.QPushButton("Add Modality")
    owner.lazy_add_mean_btn = QtWidgets.QPushButton("Add Mean View")
    owner.lazy_add_std_btn = QtWidgets.QPushButton("Add Std View")
    ...
    owner.lazy_auto_update_chk.setVisible(False)
    owner.lazy_apply_btn = QtWidgets.QPushButton("Update Canvas")
    owner.lazy_apply_btn.setEnabled(False)
    owner.lazy_apply_btn.setVisible(False)
    controls_row.addWidget(owner.lazy_add_raw_btn)
    controls_row.addWidget(owner.lazy_add_mean_btn)
    controls_row.addWidget(owner.lazy_add_std_btn)
