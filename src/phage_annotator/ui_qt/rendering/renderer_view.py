...
class RenderingViewMixin:
    """Orthoview, cursor, display mapping, overlay toggle, and diagnostics."""

    def _refresh_orthoview(self, prim, t_idx: int, z_idx: int, norm, cmap) -> None:
        """Document the refresh_orthoview flow."""
    ...
    def _on_orthoview_xz_click(self, x: int, z: int) -> None:
        """Document the on_orthoview_xz_click flow."""
    ...
    def _on_orthoview_yz_click(self, y: int, z: int) -> None:
        """Document the on_orthoview_yz_click flow."""
    ...
    def _default_cursor(self) -> Tuple[float, float]:
        """Document the default_cursor flow."""
    ...
    def _get_display_mapping(
        ...
        """Document the get_display_mapping flow."""
    ...
    def _toggle_overlay(self, checked: bool) -> None:
        """Document the toggle_overlay flow."""
