...
class ActionsPredictionsMixin:
    ...
    def _show_all_predictions_dialog(self) -> None:
        ...
        for row_idx, suggestion in enumerate(all_suggestions):
            ...
            if score >= 0.8:
                score_item.setBackground(QtGui.QColor(67, 160, 71, 100))
            elif score >= 0.5:
                score_item.setBackground(QtGui.QColor(253, 216, 53, 100))
            else:
                score_item.setBackground(QtGui.QColor(244, 67, 54, 100))
            ...
            if ml_pred is True:
                ml_pred_item.setBackground(QtGui.QColor(67, 160, 71, 100))
            elif ml_pred is False:
                ml_pred_item.setBackground(QtGui.QColor(244, 67, 54, 100))
            ...
            if ml_conf is not None:
                ...
                if conf_val >= 0.75:
                    ml_conf_item.setBackground(QtGui.QColor(67, 160, 71, 80))
                elif conf_val >= 0.5:
                    ml_conf_item.setBackground(QtGui.QColor(253, 216, 53, 80))
                else:
                    ml_conf_item.setBackground(QtGui.QColor(244, 67, 54, 80))
