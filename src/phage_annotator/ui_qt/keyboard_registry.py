...
SHORTCUTS: Tuple[ShortcutEntry, ...] = (
    ShortcutEntry("open_files", "Ctrl+O", "Open Files", "Open one or more image files", menu_action_attr="open_files_act"),
    ShortcutEntry(
        "open_folder",
        "Ctrl+Alt+O",
        "Open Folder",
        "Open a folder of supported image files",
        menu_action_attr="open_folder_act",
    ),
    ShortcutEntry(
        "save_project",
        "Ctrl+S",
        "Save Project",
        "Save the current project workspace",
        menu_action_attr="save_proj_act",
    ),
    ShortcutEntry(
        "save_annotations_csv",
        "Ctrl+Shift+S",
        "Save Annotations CSV",
        "Save the active annotation context to CSV",
        menu_action_attr="save_csv_act",
    ),
    ShortcutEntry(
        "load_project",
        "Ctrl+Alt+L",
        "Load Project",
        "Load a saved project workspace",
        menu_action_attr="load_proj_act",
    ),
    ShortcutEntry(
        "preferences",
        "Ctrl+,",
    ...
    ShortcutEntry(
        ...
        "Ctrl+E",
        "Export View",
        "Export the current rendered view",
        menu_action_attr="export_view_act",
    ),
    ShortcutEntry(
        "help_shortcuts",
        "F1",
    ...
    ShortcutEntry("accept_current_suggestion", "Shift+A", "Accept Current Suggestion", "Accept focused suggestion only (assist mode)"),
    ...
    ShortcutEntry(
        ...
        "Ctrl+Shift+Q",
        "Validate QC",
        "Run QC validation on loaded annotations",
        menu_action_attr="qc_validate_act",
    ),
    ShortcutEntry(
        "toggle_diagnostics",
        "Ctrl+Alt+D",
        "Toggle Diagnostics",
        "Show or hide the diagnostics dock",
        menu_action_attr="toggle_logs_act",
    ),
    ShortcutEntry(
        "panel_policy",
        "Ctrl+Alt+,",
        "Panel Behavior",
        "Open panel auto-open and pinning preferences",
        menu_action_attr="open_panel_policy_act",
    ),
)
