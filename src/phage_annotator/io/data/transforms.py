...
def roi_rect_in_display_coords(
    ...
    """Convert a full-resolution ROI rect to display coordinates."""
    y_full, x_full = roi_rect_full[1], roi_rect_full[0]
    y_disp, x_disp = full_to_display(y_full, x_full, crop_rect, downsample)
    w_disp = roi_rect_full[2] / downsample
    h_disp = roi_rect_full[3] / downsample
    return (x_disp, y_disp, w_disp, h_disp)
