"""Method group 1 split from annotation_io.py."""
...
class _SessionAnnotationIOMixinMethods1:
    ...
    def load_annotations(
        ...
        *,
        ...
        """Document the load_annotations flow."""
        paths, _ = QtWidgets.QFileDialog.getOpenFileNames(
            parent,
            "Load annotations",
            str(pathlib.Path.cwd()),
    ...
    def _parse_annotations_from_paths(
        ...
        *,
        ...
        """Document the parse_annotations_from_paths flow."""
    ...
    def _record_annotation_imports(self, imports: List[Tuple[int, Dict[str, object]]]) -> None:
        """Document the record_annotation_imports flow."""
    ...
    def _merge_annotations(self, image_id: int, new_points: List[Keypoint]) -> None:
        """Document the merge_annotations flow."""
