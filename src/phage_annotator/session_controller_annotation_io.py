...
from phage_annotator.annotation_metadata import merge_meta, parse_csv_header_meta, parse_filename_tokens, parse_json_meta
from phage_annotator.annotations import Keypoint, keypoints_from_csv, keypoints_from_json, save_keypoints_csv, save_keypoints_json
        ...
        if roi and roi.rect:
            ...
            if self.view_state.crop_rect:
                ...
                display = {
                    ...
                    "lut": self._colormaps[mapping.lut] if self._colormaps and mapping.lut < len(self._colormaps) else mapping.lut,
                    ...
                    if img.id == image_id:
                        ...
                        if self.session_state.smlm_runs:
                            ...
                            if self.session_state.threshold_settings:
                                meta.setdefault("provenance", {})["threshold"] = dict(self.session_state.threshold_settings)
                                return meta
