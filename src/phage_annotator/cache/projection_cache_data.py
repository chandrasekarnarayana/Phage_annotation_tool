...
class ProjectionCacheDataMixin:
    """Compatibility placeholder for a previously generated method group."""
...
class ProjectionCachePart1:
    """Method group 1 extracted from ProjectionCache."""
