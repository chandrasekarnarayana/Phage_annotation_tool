"""Feature extraction methods for local-peak suggestion model.

Contains spot quality assessment, Gaussian fitting, illumination correction,
and image statistics methods used during candidate evaluation.
"""
...
from phage_annotator.analysis.peak_suggestion_base import LocalPeakSuggestionModelConfig


class LocalPeakFeatureExtractor(LocalPeakSuggestionModelConfig):
    """Feature extraction mixin for LocalPeakSuggestionModel."""
