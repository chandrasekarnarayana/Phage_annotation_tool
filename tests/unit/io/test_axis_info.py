"""Unit tests for image-axis metadata parsing."""

from phage_annotator.io import parse_axes_info


def test_parse_axes_info_with_channels() -> None:
    """Verify parse axes info with channels for the current workflow."""
...
def test_parse_axes_info_heuristic_time() -> None:
    """Verify parse axes info heuristic time for the current workflow."""
